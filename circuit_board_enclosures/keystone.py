...
def keystone_hole():
    depth = KEYSTONE_DEPTH + KEYSTONE_THICKNESS
    return down(KEYSTONE_THICKNESS/2)(grounded_cube([
        KEYSTONE_WIDTH - KEYSTONE_THICKNESS / 2,
        KEYSTONE_LENGTH - KEYSTONE_THICKNESS / 2,
        depth
    ]))
