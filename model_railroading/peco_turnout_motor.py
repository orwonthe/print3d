...
SOCKET_HOLE_WIDTH = 7.2 @ mm

# Y dimensions
CLAMP_LENGTH = 37.0 @ mm
HOUSING_THICKNESS = 0.6 @ mm
...
SLIDER_HOLE_LENGTH = 1.4 @ mm
SLIDER_HOLE_BIAS = 1.0 @ mm
SLIDER_LENGTH = 19.8 @ mm - 2 * SLIDER_HOLE_BIAS
